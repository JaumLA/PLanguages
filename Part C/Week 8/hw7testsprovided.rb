...
i = LineSegment.new(1.0,1.0,5.0,6.0).intersect(Point.new(5.0,5.0)).preprocess_prog.eval_prog([])
puts i

i = LineSegment.new(1.0,5.0,2.0,2.0).intersect(Line.new(5.0,0.0)).preprocess_prog.eval_prog([])

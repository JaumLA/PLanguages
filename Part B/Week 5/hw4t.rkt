...
(define (powers-of-two x) (lambda () (cons (expt 2 x) (powers-of-two (+ x 1)))))
(define a 2)
...
(define tests
  (test-suite
   ...
   (check-equal? (sequence 1 4 1) (list 1 2 3 4) "Sequence test")
   (check-equal? (sequence 1 4 2) (list 1 3) "Sequence test")
   (check-equal? (sequence 1 4 5) (list 1) "Sequence test")
   (check-equal? (sequence 2 1 5) (list) "Sequence test")
   ...
   (check-equal? (stream-for-n-steps (powers-of-two 0) 2) (list 1 2) "stream-for-n-steps test")
   (check-equal? (stream-for-n-steps (powers-of-two 1) 6) (list 2 4 8 16 32 64) "stream-for-n-steps test")
